...
class Loader:
    ...
    def load_single_table(self, table: BaseTable) -> None:
        self.table_info[table.query.table_name] = table
        self.data[table.query.table_name] = self.load_table_from_query(table.query)
