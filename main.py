...
from src.database.tables import ManagerTable, CustomerTable, OrdersTable, ProductTable, DiscountTable, \
    InventoryTable
...
def main():
    ...
    tables = [ManagerTable(), CustomerTable(), ProductTable(),
              DiscountTable(), InventoryTable(), OrdersTable()]
    ...
    customer_app = EntityApp(entity_type=Customer,
    ...
    if st.session_state.current_user_access != AccessLevel.user.value:
        discount_app = DiscountApp(entity_type=Discount,
